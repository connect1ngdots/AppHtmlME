...
tempFull = sys.argv[6].decode('utf-8')
tempFull2 = sys.argv[7].decode('utf-8')
tempLarge = sys.argv[8].decode('utf-8')
tempMedium = sys.argv[9].decode('utf-8')
tempSmall = sys.argv[10].decode('utf-8')
tempLink = sys.argv[11].decode('utf-8')
