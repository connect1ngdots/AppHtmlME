...
def getStar(val):
    star = u"<img alt='' src='http://r.mzstatic.com/htmlResources/63F7/images/rating_star.png'>"
    half = u"<img alt='' src='http://r.mzstatic.com/htmlResources/63F7/images/rating_star_half.png'>"
    if val is None:
        ret = u"無し"
    else:
        v = str(val).split(".")
...
def getApp(jsonData, knd, scs, ipd, mac, aff, fmt):
    ...
    if knd != "macSoftware":
        ...
        if features and 'gameCenter' in features:
            app['gamecenter'] = u"<img width='100' alt='GameCenter対応' src='http://r.mzstatic.com/htmlResources/AEB5/web-storefront/images/gc_badge.png'>"
        if features and 'iosUniversal' in features:
            app['univ'] = u"<img alt='+' src='http://r.mzstatic.com/htmlResources/AEB5/web-storefront/images/fat-binary-badge-web.png'> iPhone/iPadの両方に対応"
